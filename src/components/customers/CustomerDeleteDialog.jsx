      ...
      <div className="relative w-full max-w-md bg-[#111] border border-white/10 rounded-2xl shadow-2xl shadow-red-900/30 animate-fade-up overflow-hidden">
        ...
        <div className="p-5 space-y-4">
          <p className="text-gray-300 text-sm leading-relaxed">
            Are you sure you want to delete <span className="text-white font-semibold">"{customer.name}"</span>? 
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-4 flex gap-3">
            ...
            <div className="text-xs text-yellow-200/80 leading-relaxed">
              <strong className="text-yellow-400">Warning:</strong> Deleting this customer may affect:
