            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-900 dark:text-white">
                      User ID: {customerDetails.created_by || 'N/A'}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-900 dark:text-white">
                      {customerDetails.created_at ? 
                        format(new Date(customerDetails.created_at), 'MMM dd, yyyy HH:mm') : 'N/A'}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                ...
                <div className="text-gray-600 dark:text-gray-400">
                  <p>
                    This customer record was created on{' '}
                    {customerDetails.created_at ? 
                      format(new Date(customerDetails.created_at), 'MMMM dd, yyyy') : 'an unknown date'}.
                  </p>
                  {customerDetails.email && (
                    <p className="mt-2">
                      Primary contact email: <span className="text-gray-900 dark:text-white">{customerDetails.email}</span>
                    </p>
                  )}
                  {customerDetails.phone && (
                    <p className="mt-2">
                      Primary contact phone: <span className="text-gray-900 dark:text-white">{customerDetails.phone}</span>
                    </p>
                  )}
                </div>
              </div>
