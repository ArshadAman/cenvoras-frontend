            ...
            <div className="flex items-center gap-4">
              {data && (
                <div className="text-right">
                  ...
                  <p className="text-xl font-bold text-red-400">₹{Number(data.total_value_at_risk || 0).toLocaleString('en-IN')}</p>
                </div>
              )}
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-white/10 bg-white/5">
                  ...
                  <th className="p-4 text-xs font-bold text-gray-400 uppercase text-right">Value (₹)</th>
                ...
                {isLoading ? (
                  ...
                  results.map((item, idx) => (
                    <tr key={idx} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                      ...
                      <td className="p-4 text-sm text-gray-300 text-right">₹{Number(item.value).toLocaleString('en-IN')}</td>
                      <td className="p-4">
